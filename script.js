...
function init(){ // run when the body loads
    ...
    ctxvowels.font = Math.round(canvasScaleVowels*10)+"px Georgia"
    vowels = new Image()
    vowels.src = "New_Zealand_English_monophthong_chart.png"
    vowelText = [["ʉː", "u", 52, 10],["e", "E", 31, 23], ["ɵː","3",52,34], ["ʊ", "U", 87, 25], ["ə","@",74,52], ["ɘ","I",79,40], ["oː", "$",110, 28], ["ɛ", "{", 53, 64], ["ɒ","Q",115, 60], ["ɐː", "#", 97, 96],["iː", "i", 28, 14], ["ɐ", "V", 85, 96]]
